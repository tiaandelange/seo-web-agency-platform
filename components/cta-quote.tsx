...
export function CtaQuote({
  ...
  body = 'Tell us what you need and get a straight answer — a fixed quote after one scoping conversation, no obligation.',
      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="rounded-card border border-line bg-canvas p-8">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4">
            <Link
              href={ctaHref}
              className="rounded-card bg-accent px-5 py-3 font-semibold text-accent-contrast hover:opacity-90"
            >
              {ctaLabel}
            </Link>
