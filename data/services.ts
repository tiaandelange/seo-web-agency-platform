...
export const services: Service[] = [
  ...
  },
  {
    ...
    relatedProjectSlugs: ['proplytic-property-software', 'admin-quotation-platform-template'],
    relatedArticleSlugs: ['what-is-an-seo-first-website'],
  ...
  },
  {
    ...
    relatedProjectSlugs: ['admin-quotation-platform-template', 'proplytic-property-software'],
    relatedArticleSlugs: [],
