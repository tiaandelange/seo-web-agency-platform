...
export const services: Service[] = [
  ...
  },
  {
    ...
    relatedProjectSlugs: ['property-management-system-template', 'admin-quotation-platform-template'],
    relatedArticleSlugs: ['what-is-an-seo-first-website'],
  ...
  },
  {
    ...
    relatedProjectSlugs: ['admin-quotation-platform-template', 'property-management-system-template'],
    relatedArticleSlugs: [],
  ...
  },
  {
    ...
    relatedPackageSlugs: ['custom-web-system'],
    relatedSolutionSlugs: ['manufacturers-and-suppliers', 'engineering-companies'],
    relatedProjectSlugs: ['admin-quotation-platform-template', 'catalogue-rfq-website-template'],
    relatedArticleSlugs: [],
