...
- 58 routes = 50 indexable + 8 noindex. Do not add, remove or rename URLs without a documented SEO reason recorded in `docs/DECISION-LOG.md` and mirrored in `docs/architecture/URL-REGISTER.csv`.
