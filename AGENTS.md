...
- 68 routes = 59 indexable + 9 noindex. Do not add, remove or rename URLs without a documented SEO reason recorded in `docs/DECISION-LOG.md` and mirrored in `docs/architecture/URL-REGISTER.csv`.
